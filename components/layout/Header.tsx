...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 px-6 sm:px-8 py-3 sm:py-4 flex justify-center sm:justify-end items-center bg-transparent text-white backdrop-blur-sm">
